...
- the live stack-open trace was rerun after the approved-visual merge with a hidden stack-panel prewarm, and the live first-frame series is back in the green band: `21.35 ms`, `18.74 ms`, `22.22 ms`.
...
| `P5` | `A2` live stack-open trace harness | real `Cmd + 2 -> first frame` panel presentation timing, rerun against the current Debug build after the approved-visual merge | `n/a` | `rerun series = 21.35 ms`, `18.74 ms`, `22.22 ms` | `scripts/record_stack_open_trace.sh --app <Prompt Cue.app>` | accepted | the hidden stack-panel prewarm preserves the approved visuals while removing the cold first-open penalty; live trace artifacts: `/tmp/promptcue-traces/stack-open/20260310-020405-12610`, `/tmp/promptcue-traces/stack-open/20260310-020443-12728`, `/tmp/promptcue-traces/stack-open/20260310-020456-12800` |
