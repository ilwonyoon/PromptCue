...
enum PrimitiveTokens {
    ...
    enum Shadow {
        ...
        static let captureAmbientOpacity: Double = 0.96
        static let captureAmbientBlur: CGFloat = 38
        static let captureAmbientY: CGFloat = 20
        static let captureKeyOpacity: Double = 0.68
        static let captureKeyBlur: CGFloat = 20
        static let captureKeyY: CGFloat = 8
